...
--
-- Database: `cross_platform_reputation_generation`
--
CREATE DATABASE IF NOT EXISTS `cross_platform_reputation_generation` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `cross_platform_reputation_generation`;
...
(1, 'Manjunath', 'tmksmanju13@gmail.com', 'Manjunath', '9535866270', 'India', 'Karnataka', 'Bangalore', '#8928,4th Cross,Rajajinagar', 'Male'),
(2, 'tmksmanju', 'tmksmanju123@gmail.com', 'tmksmanju', '9535866270', 'India', 'Karnataka', 'Bangalore', '#8928,4th Cross,Rajajinagar', 'Male');
...
(5, 'Extra Tree Classifier', '72.31270358306189'),
(6, 'SVM', '78.82736156351791'),
(7, 'Logistic Regression', '82.08469055374593'),
(8, 'Gradient Boosting Classifier', '79.15309446254072');
...
(9, 'Positive Reputation', '75.0'),
(10, 'Negative Reputation', '25.0');

-- --------------------------------------------------------

--
-- Table structure for table `remote_user_predict_reputation_generation`
--

CREATE TABLE IF NOT EXISTS `remote_user_predict_reputation_generation` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `pid` varchar(300) NOT NULL,
  `ProductId` varchar(300) NOT NULL,
  `Post_Review` varchar(30000) NOT NULL,
  `Platform` varchar(300) NOT NULL,
  `Rating` varchar(300) NOT NULL,
  `Date` varchar(300) NOT NULL,
  `Helpful` varchar(300) NOT NULL,
  `Prediction` varchar(300) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=5 ;

--
-- Dumping data for table `remote_user_predict_reputation_generation`
--

INSERT INTO `remote_user_predict_reputation_generation` (`id`, `pid`, `ProductId`, `Post_Review`, `Platform`, `Rating`, `Date`, `Helpful`, `Prediction`) VALUES
(1, '166', 'B0009XLVG0', 'This plush is gorgeous!! I bought it for my 6-month-old to help him sleep alone. Actually the otter was literally kidnapped by my 2-year-old son. He fell in love with the belly that goes up and down and doesn''t want to be without it anymore. The otter is fantastic easy to wash. Even the music adjustments, tummy light up and down are easy to set up. I''m really happy with the purchase.', 'Amazon', '5', '11-10-20', '0', 'Positive Reputation'),
(2, '286', 'B0001PB9FY', 'One of the most successful purchases, Ettore is literally in love with it. We use it mainly in the evening when we have to put him to bed... music is also great for adults', 'Flipcart', '5', '05-01-20', '0', 'Negative Reputation'),
(3, '393', 'B001EO5QW8', 'Unfortunately I had to make the return for product not working.', 'Amazon', '2', '11-11-22', '1', 'Positive Reputation'),
(4, '1316', 'B0019CW0HE', 'It works! And it''s the most important thing! It helps a lot both to relax, that to accompany the children towards the bed, but it works well also as anti-stress, for those moments when the puppets tend to be more "soundy" or they feel neglected. Excellent pet this otter! (even if many will exchange it for a bear...), it turns out to be much more useful than expected. If you don''t find it disturbing! Actually the breath, with movement, colors and sounds, is very realistic. In fact you can set noises, relaxing sounds (also human like the heartbeat) and music. You can match us a soft light on the belly, and see it move following the breath. Everything is customizable and can be activated by the battery pack, which has a rather tenacious button, to prevent it from starting inadvertently. The integrated timer is about 30 minutes! Shuttering the battery pack, you can also wash in the washing machine! Also, I would have a little flaw for the rest, I would have been finely padded to the rest of the rest of the material!', 'Flipcart', '5', '13-11-22', '6', 'Positive Reputation');
