...
ROOT_URLCONF = 'cross_platform_reputation_generation.urls'
...
WSGI_APPLICATION = 'cross_platform_reputation_generation.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'cross_platform_reputation_generation',
        'USER':'root',
        'PASSWORD': '',
        'HOST' :'127.0.0.1',
        'PORT' :'3306',
