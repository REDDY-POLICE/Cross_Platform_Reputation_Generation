"""cross_platform_reputation_generation URL Configuration
...
from cross_platform_reputation_generation import settings
...
urlpatterns = [
    ...
    url(r'^Predict_Sentiment_Reputation_Type/$', remoteuser.Predict_Sentiment_Reputation_Type, name="Predict_Sentiment_Reputation_Type"),
    ...
    url(r'^View_Prediction_Of_Sentiment_Reputation_Type_Ratio/$', serviceprovider.View_Prediction_Of_Sentiment_Reputation_Type_Ratio, name="View_Prediction_Of_Sentiment_Reputation_Type_Ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^View_Prediction_Of_Sentiment_Reputation_Type/$', serviceprovider.View_Prediction_Of_Sentiment_Reputation_Type, name="View_Prediction_Of_Sentiment_Reputation_Type"),
